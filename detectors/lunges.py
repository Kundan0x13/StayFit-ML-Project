...
class LungesDetector(BaseExercise):
    ...
    # Required landmarks for lunge detection
    LEFT_HIP = 23
    LEFT_KNEE = 25
    LEFT_ANKLE = 27
    RIGHT_HIP = 24
    ...
    def process(self, landmarks) -> dict:
        ...
        # we will consider the knee with lower angle for lunge detection
        ...
        key_landmarks_visible = (landmarks[front_hip_idx].visibility > self.MIN_VISIBILITY and
        ...
        # check deviation of shoulders from hips for balance assessment
