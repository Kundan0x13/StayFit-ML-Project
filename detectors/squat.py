...
class SquatDetector(BaseExercise):
    ...
    # Naming the landmarks based on MediaPipe Pose Landmarks
    LEFT_HIP = 23
    LEFT_KNEE = 25
    LEFT_ANKLE = 27
    RIGHT_HIP = 24
    ...
    def process(self, landmarks):
        ...
        # we will consider the knee with higher visibility for angle calculation
        ...
        key_landmark_visible = (landmarks[hip_idx].visibility >= self.MIN_VISIBILITY and
