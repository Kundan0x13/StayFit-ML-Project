...
#         elbow_angle = self.calculate_angle( # To calculate reps
#                 self.get_point(landmarks, shoulder_idx),
#                 self.get_point(landmarks, elbow_idx),
#                 self.get_point(landmarks, wrist_idx),
#         )

#         body_angle = self.calculate_angle( # To check form
#                 self.get_point(landmarks, shoulder_idx),
#                 self.get_point(landmarks, hip_idx),
#                 self.get_point(landmarks, ankle_idx),
#         )

#         # To check hip sagging or piking
#         shoulder_y = landmarks[shoulder_idx].y
#         ankle_y = landmarks[ankle_idx].y
#         hip_y = landmarks[hip_idx].y
...
#                                  landmarks[wrist_idx].visibility > self.MIN_VISIBILITY and
...
#             if elbow_angle > self.UP_THRESHOLD and self.stage == "down":
#                 self.stage = "up"
#                 self.reps += 1          # down -> up is considered one rep   
